...
namespace WhatIsInterface
{
    public class WhatIsCollection
    {
        public void collectionDesc()
        {
             ...
             * 
             * 배열과 컬렉션
             * c#에서 배열(Array)과 컬렉션(Collection), 리스트(List)는 학습 레벨에서 동일하고 취급한다.
            ...
            // key, 값 순서의 한 쌍으로 저장한다.
            inventory.Add("빨간 포션", 10);
            inventory.Add("강철 검", 1);


            
            Console.WriteLine("빨간 포션의 개수는 {0} 이다.",
                inventory["빨간 포션"]);
