...
namespace WhatIsDelegate
{
    public class Description
    {
        public void DelegateDesc()
        {
             ...
             * 대리자는 함수 자체를 데이터 하나로 보고 의미 그대로 다른 메서드를 대신 실행하는 기능이다.
            ...
            // 매개변수가 없는 함수를 변수에 담는다.
            SayDelegate sayDelegate = Hi;

            sayDelegate.Invoke();
            // Delegate : 변수에 함수를 담는다.

        } // DelegateDesc()

        // void 리턴 타입과, 매개변수를 받지 않는 함수를 저장할 수 있는 데이터 타입을 선언한 것.
        delegate void SayDelegate();

        // float 리턴 타입과, intValue1, intValue2의 매개변수를 받는 Delegate이다.
        delegate float SayDelegate1(int intValue1, int intValue2);
